            ...
            <div class="offcanvas__content">
                ...
                <div class="offcanvas__btn d-sm-none">
                    <div class="header__btn-wrap">
                        <a class="rr-btn btn-hover-white" href="https://calendly.com/graduk879/30min">Get An Appointment<span><i class="fa-regular fa-angle-right"></i></span></a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="header__right">
                        <div class="header__action d-flex align-items-center">
                            <div class="header__btn-wrap d-none d-sm-inline-flex">
                                <a href="https://calendly.com/graduk879/30min" class="rr-btn">Get An Appointment <i class="fa-solid fa-arrow-right"></i></a>
                            </div>
