...
<link rel="shortcut icon" type="image/x-icon" href="{{ asset('assets/imgs/logo/favicon.png') }}">
<link rel="preconnect" href="{{ asset('https://fonts.googleapis.com') }}">
<link rel="preconnect" href="{{ asset('https://fonts.gstatic.com') }}" crossorigin>
<link href="{{ asset('https://fonts.googleapis.com/css2?family=Sofia&display=swap') }}" rel="stylesheet">
